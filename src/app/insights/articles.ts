...
const articles: Article[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "At Veritas AI, insurance is our Phase 1 vertical for a reason: it's regulated (trust matters), it's data-rich (claims histories, actuarial tables, policy documents), and the ROI on AI is immediate and measurable. Here's where the biggest opportunities lie in 2026.",
